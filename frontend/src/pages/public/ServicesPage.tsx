        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {loading ? (
            ...
            <div className="divide-y divide-slate-50">
              {filtered.map((s, i) => (
                <div key={s.id} className="group relative grid grid-cols-12 gap-6 py-7 hover:bg-slate-50 -mx-4 px-4 rounded-xl transition-all">
                <Link to={`/services/${s.slug}`} className="absolute inset-0 z-10" aria-label={s.name} />
